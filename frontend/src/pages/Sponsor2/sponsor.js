                    ...
                    <div className="about-tabview-content-active p-col-12 p-sm-7">
                        <TabView activeIndex={activeIndex1} onTabChange={(e) => { setActiveIndex1(e.index); }}>
                            <TabPanel >
                                ...
                                <h5 className="fw-bold">{t('aboutus-sponsors-text-one-one-vasf')}</h5>

                            </TabPanel>
                            <TabPanel >
                                <h1 className="cl-darkgreen fw-bold">{t('aboutus-sponsors')}</h1>
                                <div className="sponsor mb-10 fw-bold">
                                    <h5 className="fw-bold">{t('aboutus-sponsors-text-one-two-vasf')}</h5>
                                    <h5 className="fw-bold">{t('aboutus-sponsors-text-one-three-vasf')}</h5>
                                    <h5 className="fw-bold">{t('aboutus-sponsors-text-one-four-vasf')}</h5>
                                </div>
                            </TabPanel>
                            <TabPanel >

                                <h2 className="cl-darkgreen fw-bold">{t('sponsor-sidebar-three')}</h2>
                                <h5 className="fw-bold">{t('aboutus-sponsors-text-three-vasf')}</h5>
